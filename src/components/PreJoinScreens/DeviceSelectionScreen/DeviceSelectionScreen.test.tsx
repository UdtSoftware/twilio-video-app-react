...
describe('the DeviceSelectionScreen component', () => {
  ...
  describe('when connecting to a room', () => {
    ...
    const wrapper = shallow(
      <DeviceSelectionScreen name="test name" roomName="test room name" password="" setStep={() => {}} />
    );
  ...
  it('should go back to the RoomNameScreen when the Cancel button is clicked', () => {
    ...
    const wrapper = shallow(
      <DeviceSelectionScreen name="test name" roomName="test room name" password="" setStep={mockSetStep} />
    );
